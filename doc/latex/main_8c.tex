...
\begin{DoxyCompactList}\small\item\em Funzione main. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
{\em argc} & è il numero di argomenti passati da linea di comando \\
\hline
{\em argv} & è il vettore che contiene i parametri da linea di comando \\
\hline
\end{DoxyParams}
